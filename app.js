document.addEventListener('DOMContentLoaded', () => {
	...
	function check() {
		 ...
		 const winningArrays = [
		 	...
		 	[15, 16, 17, 18], [19, 18, 17, 16], [22, 23, 24, 15], [26, 25, 24, 23], [29, 30, 31, 32], [33, 32, 31, 30], 
		 	[36, 37, 38, 39], [41, 40, 39, 38], [40, 39, 38, 37], [7, 14, 21, 28], [8, 15, 22, 29], [9, 16, 23, 30], 
	...
	function clearBoard() {
		...
		squares.forEach(square => {
		 	if (square.classList.contains('player-one') || square.classList.contains('player-two')) {
